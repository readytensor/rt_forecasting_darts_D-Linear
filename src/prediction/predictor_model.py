...
class Forecaster:
    """A wrapper class for the DLinear Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "DLinear Forecaster"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Construct a new DLinear Forecaster
        ...
        Args:
            ...
            shared_weights (bool):
                ...
                Warning
                    When set to True, covariates will be ignored as a 1-to-1 mapping is required between input dimensions and output dimensions.

            kernel_size (int):
                The size of the kernel for the moving average (default=25).
                If the size of the kernel is even, the padding will be asymmetrical (shorter on the start/left side).

            const_init (bool):
                Whether to initialize the weights to 1/in_len. If False, the default PyTorch initialization is used (default='True').
    ...
    def fit(
        ...
        A separate DLinear model is fit to each series that is contained
        in the data.
    ...
    def load(cls, model_dir_path: str) -> "Forecaster":
        ...
        model = DLinearModel.load(os.path.join(model_dir_path, MODEL_FILE_NAME))
